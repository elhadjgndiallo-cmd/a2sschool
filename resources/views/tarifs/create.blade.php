    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-plus me-2"></i>Créer un Nouveau Tarif
            </h1>
            <p class="text-muted">Définir les frais de scolarité pour une classe et une année scolaire</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Informations du Tarif
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('tarifs.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" id="loadTarifsBtn" disabled>
                                        <i class="fas fa-download me-1"></i>Charger les tarifs
                                    </button>
                                </div>
                                @error('classe_id')
                        ...
                        <!-- Section des tarifs existants -->
                        <div id="existingTarifsSection" class="mb-4" style="display: none;">
                            <div class="alert alert-info">
                                <h6 class="mb-2">
                                    <i class="fas fa-info-circle me-2"></i>Tarifs existants pour cette classe
                                </h6>
                                <p class="mb-2">Sélectionnez un tarif existant pour pré-remplir le formulaire :</p>
                                <div id="tarifsList" class="row">
                                    <!-- Les tarifs existants seront chargés ici -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('frais_reinscription') is-invalid @enderror" 
                                       ...
                                       value="{{ old('frais_reinscription', 0) }}" 
                                       min="0" step="100">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('frais_scolarite_mensuel') is-invalid @enderror" 
                                       ...
                                       value="{{ old('frais_scolarite_mensuel', 0) }}" 
                                       min="0" step="100">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('frais_cantine_mensuel') is-invalid @enderror" 
                                       ...
                                       value="{{ old('frais_cantine_mensuel', 0) }}" 
                                       min="0" step="100">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('frais_transport_mensuel') is-invalid @enderror" 
                                       ...
                                       value="{{ old('frais_transport_mensuel', 0) }}" 
                                       min="0" step="100">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           value="1" {{ old('paiement_par_tranches', 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('periode_tranche') is-invalid @enderror" 
                                    ...
                                    <option value="mensuel" {{ old('periode_tranche', 'mensuel') == 'mensuel' ? 'selected' : '' }}>
                                        Mensuel
                                    </option>
                                    <option value="trimestriel" {{ old('periode_tranche') == 'trimestriel' ? 'selected' : '' }}>
                                        Trimestriel
                                    </option>
                                    <option value="semestriel" {{ old('periode_tranche') == 'semestriel' ? 'selected' : '' }}>
                                        Semestriel
                                    </option>
                                    <option value="annuel" {{ old('periode_tranche') == 'annuel' ? 'selected' : '' }}>
                                        Annuel
                                    </option>
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Description des frais, conditions particulières...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Créer le Tarif
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-calculator me-2"></i>Aperçu des Coûts
                    </h5>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Information:</strong> Les montants s'afficheront ici en temps réel lors de la saisie.
                    </div>
                    
                    <div id="cost-preview">
                        <div class="mb-2">
                            <strong>Frais d'inscription:</strong>
                            <span id="preview-inscription" class="float-end">0 GNF</span>
                        </div>
                        <div class="mb-2">
                            <strong>Coût mensuel total:</strong>
                            <span id="preview-mensuel" class="float-end text-primary">0 GNF</span>
                        </div>
                        <hr>
                        <div class="mb-2">
                            <strong>Coût annuel estimé:</strong>
                            <span id="preview-annuel" class="float-end text-success">0 GNF</span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const loadTarifsBtn = document.getElementById('loadTarifsBtn');
    const existingTarifsSection = document.getElementById('existingTarifsSection');
    const tarifsList = document.getElementById('tarifsList');

    // Activer/désactiver le bouton de chargement des tarifs
    classeSelect.addEventListener('change', function() {
        if (this.value) {
            loadTarifsBtn.disabled = false;
        } else {
            loadTarifsBtn.disabled = true;
            existingTarifsSection.style.display = 'none';
        }
    });

    // Charger les tarifs existants
    loadTarifsBtn.addEventListener('click', function() {
        ...
        fetch(`/api/tarifs/classe/${classeId}`)
            .then(response => response.json())
            .then(tarifs => {
                displayExistingTarifs(tarifs);
                this.innerHTML = '<i class="fas fa-download me-1"></i>Charger les tarifs';
                this.disabled = false;
            })
            .catch(error => {
                console.error('Erreur lors du chargement des tarifs:', error);
                alert('Erreur lors du chargement des tarifs existants');
                this.innerHTML = '<i class="fas fa-download me-1"></i>Charger les tarifs';
                this.disabled = false;
            });
    });
    ...
    function displayExistingTarifs(tarifs) {
        if (tarifs.length === 0) {
            tarifsList.innerHTML = '<div class="col-12"><p class="text-muted">Aucun tarif existant pour cette classe.</p></div>';
        } else {
            tarifsList.innerHTML = tarifs.map(tarif => `
                <div class="col-md-6 mb-3">
                    <div class="card border-primary">
                        <div class="card-body">
                            <h6 class="card-title text-primary">${tarif.annee_scolaire}</h6>
                            <div class="row">
                                <div class="col-6">
                                    <small class="text-muted">Inscription:</small><br>
                                    <strong>${tarif.frais_inscription.toLocaleString()} GNF</strong>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted">Scolarité/mois:</small><br>
                                    <strong>${tarif.frais_scolarite_mensuel.toLocaleString()} GNF</strong>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-6">
                                    <small class="text-muted">Cantine/mois:</small><br>
                                    <strong>${tarif.frais_cantine_mensuel.toLocaleString()} GNF</strong>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted">Transport/mois:</small><br>
                                    <strong>${tarif.frais_transport_mensuel.toLocaleString()} GNF</strong>
                                </div>
                            </div>
                            <button type="button" class="btn btn-sm btn-primary mt-2 w-100" 
                                    onclick="loadTarifData(${JSON.stringify(tarif).replace(/"/g, '&quot;')})">
                                <i class="fas fa-arrow-down me-1"></i>Utiliser ce tarif
                            </button>
                        </div>
                    </div>
                </div>
    ...
    // Fonction globale pour charger les données d'un tarif
    window.loadTarifData = function(tarif) {
        document.getElementById('frais_inscription').value = tarif.frais_inscription || 0;
        document.getElementById('frais_reinscription').value = tarif.frais_reinscription || 0;
        document.getElementById('frais_scolarite_mensuel').value = tarif.frais_scolarite_mensuel || 0;
        document.getElementById('frais_cantine_mensuel').value = tarif.frais_cantine_mensuel || 0;
        document.getElementById('frais_transport_mensuel').value = tarif.frais_transport_mensuel || 0;
        document.getElementById('frais_uniforme').value = tarif.frais_uniforme || 0;
        document.getElementById('frais_livres').value = tarif.frais_livres || 0;
        document.getElementById('frais_autres').value = tarif.frais_autres || 0;
        document.getElementById('nombre_tranches').value = tarif.nombre_tranches || 9;
        document.getElementById('periode_tranche').value = tarif.periode_tranche || 'mensuel';
        ...
        alert.innerHTML = `
            ...
            Tarif de l'année ${tarif.annee_scolaire} chargé avec succès !
