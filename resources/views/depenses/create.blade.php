...
@section('title', 'Créer une Sortie')
                    ...
                    <form action="{{ route('depenses.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type_depense" id="type_depense" 
                                        ...
                                        <option value="salaire_enseignant" {{ old('type_depense') == 'salaire_enseignant' ? 'selected' : '' }}>Salaire Enseignant</option>
                                        <option value="salaire_personnel" {{ old('type_depense') == 'salaire_personnel' ? 'selected' : '' }}>Salaire Personnel</option>
                                        <option value="achat_materiel" {{ old('type_depense') == 'achat_materiel' ? 'selected' : '' }}>Achat Matériel</option>
                                        <option value="maintenance" {{ old('type_depense') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                        <option value="electricite" {{ old('type_depense') == 'electricite' ? 'selected' : '' }}>Électricité</option>
                                        <option value="eau" {{ old('type_depense') == 'eau' ? 'selected' : '' }}>Eau</option>
                                        <option value="nourriture" {{ old('type_depense') == 'nourriture' ? 'selected' : '' }}>Nourriture</option>
                                        <option value="transport" {{ old('type_depense') == 'transport' ? 'selected' : '' }}>Transport</option>
                                        <option value="communication" {{ old('type_depense') == 'communication' ? 'selected' : '' }}>Communication</option>
                                        <option value="formation" {{ old('type_depense') == 'formation' ? 'selected' : '' }}>Formation</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      ...
                                      placeholder="Description détaillée de la sortie">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="observations" id="observations" rows="2" 
                                      ...
                                      placeholder="Observations ou notes">{{ old('observations') }}</textarea>
                        </div>
