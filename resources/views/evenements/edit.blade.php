                    ...
                    <form action="{{ route('evenements.update', $evenement->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titre" id="titre" class="form-control @error('titre') is-invalid @enderror" 
                                           value="{{ old('titre', $evenement->titre) }}" required maxlength="100">
                                    @error('titre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="cours" {{ old('type', $evenement->type) == 'cours' ? 'selected' : '' }}>Cours</option>
                                        <option value="examen" {{ old('type', $evenement->type) == 'examen' ? 'selected' : '' }}>Examen</option>
                                        <option value="reunion" {{ old('type', $evenement->type) == 'reunion' ? 'selected' : '' }}>Réunion</option>
                                        <option value="conge" {{ old('type', $evenement->type) == 'conge' ? 'selected' : '' }}>Congé</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="3" maxlength="500">{{ old('description', $evenement->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lieu" id="lieu" class="form-control @error('lieu') is-invalid @enderror" 
                                           value="{{ old('lieu', $evenement->lieu) }}" maxlength="100">
                                    @error('lieu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="classe_id" id="classe_id" class="form-control @error('classe_id') is-invalid @enderror">
                                        ...
                                        @foreach($classes as $classe)
                                            <option value="{{ $classe->id }}" {{ old('classe_id', $evenement->classe_id) == $classe->id ? 'selected' : '' }}>
                                                {{ $classe->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_fin" id="date_fin" class="form-control @error('date_fin') is-invalid @enderror" 
                                           value="{{ old('date_fin', $evenement->date_fin->format('Y-m-d')) }}" required>
                                    @error('date_fin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="color" name="couleur" id="couleur" class="form-control @error('couleur') is-invalid @enderror" 
                                           value="{{ old('couleur', $evenement->couleur) }}">
                                    @error('couleur')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="rappel" id="rappel" class="form-control @error('rappel') is-invalid @enderror" 
                                           value="{{ old('rappel', $evenement->rappel) }}" min="0">
                                    @error('rappel')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" name="journee_entiere" id="journee_entiere" class="form-check-input" 
                                               value="1" {{ old('journee_entiere', $evenement->journee_entiere) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="public" id="public" class="form-check-input" 
                                               value="1" {{ old('public', $evenement->public) ? 'checked' : '' }}>
