...
<!-- Filtres -->
<form method="GET" action="{{ route('notes.mensuel.classe', $classe->id) }}" class="mb-3">
    <div class="row g-2">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="d-flex gap-1">
                ...
                <a href="{{ route('notes.mensuel.classe', $classe->id) }}" class="btn btn-outline-secondary" title="Réinitialiser">
