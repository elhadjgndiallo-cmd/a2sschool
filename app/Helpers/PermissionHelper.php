...
class PermissionHelper
{
    ...
    public static function getFilteredSubmenus($menuType)
    {
        ...
        'notes' => [
            ...
            ['href' => $getRoute('notes.annuel.index'), 'icon' => 'fas fa-trophy', 'text' => 'Annuel', 'permission' => 'notes.view'],
            ...
            'parametres' => [
                ...
                ['href' => $getRoute('classes.index'), 'icon' => 'fas fa-school', 'text' => 'Classes', 'permission' => 'classes.view'],
                ['href' => $getRoute('matieres.index'), 'icon' => 'fas fa-book', 'text' => 'Matières', 'permission' => 'matieres.view'],
                ['href' => $getRoute('admin.notifications.index'), 'icon' => 'fas fa-envelope', 'text' => 'Messages Parents', 'permission' => 'messages.view'],
